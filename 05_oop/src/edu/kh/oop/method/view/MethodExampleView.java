...
public class MethodExampleView {
	...
	public void displayMenu() {
		...
		do {
			...
			System.out.println("2. 매개변수 X, 리턴 값이 O");
			System.out.println("2. 매개변수 O, 리턴 값이 O");
			...
			switch (input) {
			case 1:	service.method1(); break;		// 1이 입력 되었을때 service가 참조하는 객체의 method1() 메서드 호출 
			case 2: // service.method2(50, 76, 23); break;
				menu2();
				break;
			case 3: 
				String result = service.method3();	// method3() 호출 후 String 값을 반환 받고
													// 그 값을 result 변수에 저장
	...
	// 정수 3개를 입력 받고, service.method2()를 호출 하는 메서드 작성
	public void menu2() {
	...
	public void menu4() {
		...
		System.out.printf("%d %s %d = %.1f", input1,  op, input2, service.method4(input1, input2, op));
