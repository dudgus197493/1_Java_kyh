...
- ### 상수 사용 예시
  ...
  - ### 자동 형변환
    ...
    - ### 자동 형변환 확인
      ...
      // int result = num1 + num2;				// Type mismatchcannot convert from double to int
      //              300  +  1.1 
      //              300.0 + 1.1 -> 자료형이 더 큰 num2의 자료형double로 자동 형변환됨
      // double자료형인 num1 + num2의 결과값을 더 작자료형인 int형 변수에 저장을 시도하니 컴파일러 에러
